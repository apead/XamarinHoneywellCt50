...
{
    [Activity(Label = "Manual Trigger Barcode")]
    public class ManualTriggerBarcodeActivity : Activity, BarcodeReader.IBarcodeListener, BarcodeReader.ITriggerListener
    {
        private BarcodeReader _barcodeReader;
        private ListView _barcodeList;
        private Button _initiateScanButton;
